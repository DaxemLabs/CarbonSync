...
- Press `Ctrl+D` inside the dashboard to open the developer panel — packet schema, connection log, and computation constants are all there
- For integration support: [engineering@daxem.ai](mailto:engineering@daxem.ai)

---

## For Fleet Operators & Pilot Partners

We are actively onboarding pilot partners ahead of our Q2 2026 launch. See [`PILOT_PROGRAM.md`](PILOT_PROGRAM.md) for full details on what's involved and what pilot partners receive.

To discuss participation: [partnerships@daxem.ai](mailto:partnerships@daxem.ai)

---

## For Verification Bodies & Methodology Partners

For enquiries related to Verra VCS methodology submission, SustainCERT validation engagement, or CBAM compliance:

Full methodology documentation is in [`METHODOLOGY.md`](METHODOLOGY.md).

Contact: [methodology@daxem.ai](mailto:methodology@daxem.ai)
...
We are committed to constructive, respectful engagement across all interactions. Please be specific, be helpful, and be kind.
